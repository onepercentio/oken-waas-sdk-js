...
export interface RarumCollectibles extends BaseContract {
  ...
  methods: {
    ...
    URI_SETTER_ROLE(): NonPayableTransactionObject<string>;
    ...
    collectionOf(wallet: string): NonPayableTransactionObject<{
      0: string[];
      1: string[];
    }>;
    ...
    getRegisteredTokens(): NonPayableTransactionObject<string[]>;
    ...
    setBaseURI(newuri: string): NonPayableTransactionObject<void>;
