...
export interface LootBoxBatchMintInterface extends utils.Interface {
  functions: {
    "ADMIN_ROLE()": FunctionFragment;
    "DEFAULT_ADMIN_ROLE()": FunctionFragment;
    "authorizations(bytes32)": FunctionFragment;
...
export interface LootBoxBatchMint extends BaseContract {
  ...
  interface: LootBoxBatchMintInterface;
  ...
  functions: {
    ...
    batchMint(
      ...
      _authorizations: PromiseOrValue<BytesLike>[],
