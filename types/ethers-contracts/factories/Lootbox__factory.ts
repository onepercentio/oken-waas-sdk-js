...
import type { Lootbox, LootboxInterface } from "../Lootbox";
...
const _abi = [
  ...
  },
  {
    inputs: [
      {
        internalType: "enum LootBox.Option",
        name: "_option",
        type: "uint8",
      },
      {
  ...
  },
  {
    inputs: [
      {
        internalType: "enum LootBox.Class",
        name: "_class",
        type: "uint8",
      },
      {
...
export class Lootbox__factory {
  static readonly abi = _abi;
  static createInterface(): LootboxInterface {
    return new utils.Interface(_abi) as LootboxInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): Lootbox {
    return new Contract(address, _abi, signerOrProvider) as Lootbox;
  }
}
