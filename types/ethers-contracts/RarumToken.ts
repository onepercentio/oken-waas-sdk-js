...
export interface RarumTokenInterface extends utils.Interface {
  functions: {
    "DEFAULT_ADMIN_ROLE()": FunctionFragment;
    "DOMAIN_SEPARATOR()": FunctionFragment;
    "MINTER_ROLE()": FunctionFragment;
    "PAUSER_ROLE()": FunctionFragment;
    "__ERC20AuthorizedPermit_init(string)": FunctionFragment;
    "__ERC20AuthorizedPermit_init_unchained()": FunctionFragment;
    "allowance(address,address)": FunctionFragment;
    "approve(address,uint256)": FunctionFragment;
    "authorizationState(address,bytes32)": FunctionFragment;
    "authorize(address,address,uint256,bytes32,uint256,uint8,bytes32,bytes32)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "__ERC20AuthorizedPermit_init",
    values: [PromiseOrValue<string>]
  ): string;
  encodeFunctionData(
    functionFragment: "__ERC20AuthorizedPermit_init_unchained",
    values?: undefined
  ): string;
  encodeFunctionData(
